...
public class ImportExportEndpointTest extends BaseTest {
    ...
    public void testExport() throws Exception {
        ...
        assertEquals("2024-06-20,testExpense0,Food,100.0,EUR,40.00,-40.00,0.00,0.00,0.00,0.00", lines[1]);
        assertEquals("2024-06-20,testExpense1,Food,100.0,EUR,50.00,-20.00,-30.00,0.00,0.00,0.00", lines[2]);
        assertEquals("2024-06-20,testExpense2,Food,100.0,EUR,-10.00,90.00,-80.00,0.00,0.00,0.00", lines[3]);
        assertEquals("2024-06-20,Settle debts,Payment,20.0,EUR,-20.00,20.00,0.00,0.00,0.00,0.00", lines[4]);
        assertEquals("2024-06-20,Settle debts,Payment,420.0,EUR,0.00,0.00,0.00,0.00,420.00,-420.00", lines[5]);
    }
}
